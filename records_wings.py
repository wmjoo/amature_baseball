...
with tab_sn_teams: # 팀 기록 탭
    ...
    with tab_sn_teams_allteams: # 전체 팀 탭   
        ...
        target = hitter_heatmap_df[hitter_heatmap_df['name'].str.contains('SKCC')]  # 2. 특정 문자열이 있는 행 필터링
        others = hitter_heatmap_df[~hitter_heatmap_df['name'].str.contains('SKCC')]         # 3. 나머지 행 필터링
