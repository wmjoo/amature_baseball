...
with tab_sn_teamwise:
    ...
    st.dataframe(df_hitter[rank_by_cols_h_sorted[1:]].mean().T, use_container_width = True, hide_index = True)
    st.dataframe(df_pitcher[rank_by_cols_p_sorted[2:]].mean().T, use_container_width = True, hide_index = True)
